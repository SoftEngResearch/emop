...
if (!firstRun.exists()) {
    ...
    assert affectedSpecsMessage == "URLDecoder_DecodeUTF8MonitorAspect,Throwable_InitCauseOnceMonitorAspect" : "Unexpected affected specs message for subsequent runs!"
    firstRun.delete()
}
